 ...
 * Mon Oct 11 2021 17:09:05 GMT+0200 (CEST)
...
eventHTMLElem('mouseover', 'fold_knife_button', true, function(event) {
  autoRotateCamera(false, 2);
});

eventHTMLElem('mouseover', 'unfold_knife_button', true, function(event) {
