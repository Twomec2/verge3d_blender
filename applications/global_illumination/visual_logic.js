 ...
 * Sun Oct 03 2021 10:32:49 GMT+0300 (Moscow Standard Time)
...
eventHTMLElem('click', 'lightstand_light', false, function(event) {
  if (lightstand_light == false) {
    ...
    setMaterialValue('lightstand', 'Value', 30);
...
eventHTMLElem('click', 'dinner_zone_light', false, function(event) {
  if (dinner_zone_light == false) {
    setLightParam('INTENSITY', 'dinner_zone_light', 400);
    if (day == true) {
      setMaterialValue('dinner_zone_light_wood', 'Value', 0.096);
    } else {
      setMaterialValue('dinner_zone_light_wood', 'Value', 10);
    }
    dinner_zone_light = true;
    setHTMLElemStyle('backgroundImage', 'url(icons/bulb_on.svg)', 'dinner_zone_light', false);
    updateLightProbe('ReflectionCubemap');
  } else {
