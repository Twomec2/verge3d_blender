 ...
 * Sun Oct 03 2021 10:33:52 GMT+0300 (Moscow Standard Time)
...
function clock_action(arrow, arrow_speed) {
  if (drink == 'Nothing' || drink == 'Hot Water' || drink == 'Warm Water' || drink == 'Cold Water') {
    setObjTransform(arrow, false, 'rotation', [arrow_speed, '', ''], true);
  } else if (drink == 'Warm Water') {
    setObjTransform(arrow, false, 'rotation', [arrow_speed, '', ''], true);
  } else if (drink == 'Cocoa') {
    setObjTransform(arrow, false, 'rotation', [110, '', ''], false);
  } else if (drink == 'Instant Noodles') {
    setObjTransform(arrow, false, 'rotation', [53, '', ''], false);
  } else if (drink == 'Green Tea') {
    setObjTransform(arrow, false, 'rotation', [200, '', ''], false);
  } else if (drink == 'Coffee') {
    setObjTransform(arrow, false, 'rotation', [147, '', ''], false);
  } else if (drink == 'Black Tea') {
    setObjTransform(arrow, false, 'rotation', [100, '', ''], false);
  } else if (drink == 'Hot Chocolate') {
    setObjTransform(arrow, false, 'rotation', [50, '', ''], false);
  }
}
...
registerEveryFrame(function() {
  ...
  if (teapot_boiling == 1) {
    if (steam_pressure >= overall_pressure * -1) {
      ...
      setObjTransform('teapot_arrow', false, 'rotation', ['', steam_pressure, ''], false);
...
registerEveryFrame(function() {
  if (windows_charged[3] == 1) {
    if (windows_installed[3] == 1) {
      setObjTransform('grid', false, 'rotation', ['', '', appInstance.elapsed * 10], true);
    } else if (windows_installed[3] == 2) {
      setObjTransform('grid', false, 'rotation', ['', '', appInstance.elapsed * 15], true);
    } else if (windows_installed[3] == 3) {
      setObjTransform('grid', false, 'rotation', ['', '', appInstance.elapsed * 20], true);
    }
  }
});
